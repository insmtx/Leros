...
const file_common_base_proto_rawDesc = "" +
	"\n" +
	"\x11common/base.proto\x12\x0fsingeros.common\"^\n" +
	"\x04Meta\x12\x1d\n" +
	"\n" +
	...
	"\amessage\x18\x02 \x01(\tR\amessageB)Z'github.com/insmtx/SingerOS/proto/commonb\x06proto3"
...
var file_common_base_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_common_base_proto_goTypes = []any{
	(*Meta)(nil),       // 0: singeros.common.Meta
	(*Pagination)(nil), // 1: singeros.common.Pagination
	(*Error)(nil),      // 2: singeros.common.Error
}
